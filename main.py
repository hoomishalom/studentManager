...
class ManagerApp(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.addLessonFrame = addLesson.AddLesson(self, self.STUDENTS_PATH, self.dateFormat, self.rateLocation, self.lesssonCountLocation, height=(self.HEIGHT * 0.6 - 2 * self.framePading), width=(self.WIDTH * self.studentFrameRatio - 2 * self.framePading))
